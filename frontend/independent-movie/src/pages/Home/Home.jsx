        ...
        <div className="page">
            ...
            <header className="header">
                <div className="container header-inner">
                    <div className="logo">Independent Movie</div>
                    ...
                    <div className="header-auth">
                        ...
                        <button className="btn-primary small">회원가입</button>
                    </div>
                </div>
            </header>
            ...
            <section className="section boxoffice">
                <div className="container">
                    ...
                    <div className="boxoffice-grid">
                        {[1, 2, 3].map((i) => (
                            <div key={i} className="boxoffice-card">
                    ...
                    <div className="help-grid">
                        ...
                        <div className="help-card">
                            ...
                            <ol className="steps">
                                <li className="step">
                                    ...
                                    <div className="step-body">
                                        ...
                                        <div className="step-sub">박스오피스(PREMIUM) / 일반(BASIC)</div>
                                    </div>
                                </li>
                                <li className="step">
                                    ...
                                    <div className="step-body">
                                        ...
                                        <div className="step-sub">커플룸 · 프라이빗룸 · 단체룸</div>
                                    </div>
                                </li>
                                <li className="step">
                                    ...
                                    <div className="step-body">
                                        ...
                                        <div className="step-sub">마이페이지에서 확인/취소</div>
                                    </div>
                                </li>
                            </ol>
                            ...
                            <div className="help-actions">
                                ...
                                <button className="btn-outline small">이용 방법 자세히</button>
                            </div>
                        </div>
                        ...
                        <div className="help-card">
                            <div className="help-card__top">
                                ...
                                <p className="help-desc">가장 많이 물어보시는 내용만 먼저 보여드려요.</p>
                            </div>

                            <div className="faq-mini">
                                <details className="faq-item">
                                    <summary>취소/환불 규정은 어떻게 되나요?</summary>
                                    <p>현재는 예약 취소 기능만 제공하며, 운영 정책은 공지로 안내됩니다.</p>
                                </details>

                                <details className="faq-item">
                                    <summary>인원 수는 어떻게 선택하나요?</summary>
                                    <p>공간 유형별 최소/최대 인원 범위 안에서 예약 시 선택합니다.</p>
                                </details>

                                <details className="faq-item">
                                    <summary>공간 이용 시간은 얼마나 되나요?</summary>
                                    <p>상영 스케줄 기준으로 운영되며, 준비/정리 시간은 운영 정책에 따릅니다.</p>
                                </details>
                            </div>
                        ...
                        <div className="help-card">
                            <div className="help-card__top">
                                ...
                                <p className="help-desc">최근 공지를 확인하고 불편 없이 이용하세요.</p>
                            </div>
