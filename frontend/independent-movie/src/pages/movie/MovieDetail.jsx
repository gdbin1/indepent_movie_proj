...
export default function MovieDetail() {
    ...
    if (loading) {
        return <div className="movie-detail-loading">로딩 중...</div>;
    }

    if (!movie) {
        return <div className="movie-detail-error">영화를 찾을 수 없습니다.</div>;
    }
        ...
        <UserLayout>
            <div className="page">
                <section className="movie-detail">
                    <div className="movie-detail-top-nav">
                        <button
                    ...
                    <div className="container movie-detail-inner">
                        {/* ================= POSTER ================= */}
                        ...
                        <div className="movie-info-area">
                            <span
                                className={`movie-grade ${movie.priceGrade === "PREMIUM" ? "premium" : "basic"
                                    }`}
                            >
                                {movie.priceGrade}
                            </span>
                            ...
                            {/* ===== INFO CARDS ===== */}
                            <div className="movie-info-cards">
                                ...
                                <div className="info-card">
                                    <label>관람 요금</label>
                                    <strong>
                                        {movie.priceGrade === "PREMIUM" ? "35,000원" : "일반 요금"}
                                    </strong>
                                </div>
                                <div className="info-card">
                                    <label>상영 상태</label>
                            ...
                            <div className="movie-actions">
                                ...
                                <button className="btn-outline">관심 영화</button>
                                <button
                                    className="btn-back"
                                    onClick={() => navigate(-1)}
                                >
